...
const styles = StyleSheet.create({
  ...
  category: { color: colors.accent, fontSize: typography.small, fontFamily: fonts.bold, letterSpacing: 1, marginTop: spacing.md },
  ...
  subtitle: { color: colors.text, fontSize: typography.section, fontFamily: fonts.bold, marginTop: spacing.md },
  title: { color: colors.text, fontSize: typography.heading, fontFamily: fonts.bold, lineHeight: 37, marginTop: spacing.sm },
});
